        ...
        <div class="container">
            ...
            <div class="codrops-top">
                ...
                <header>
                  ...
                  <a href="creer_sous_theme.php"> <input type="submit" class="menu_button" value="créer un theme "/> </a> &nbsp; &nbsp;
            ...
            ?>          
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
					 ...
					 <form action="php/ajout_support.php" method="POST" name="ajout_support" autocomplete="on">
                                            <h1>Create a support </h1>
                            <p>  
                            ...
                            <select name="categorie" id="categorie" onchange="showHint()">
                                ...
                                <p>  
                               <label for="namesupport" class="namesupport"  > Theme  </label> </br>
                                 ...
                                 <p> 
                                    ...
                                    <input id="nametheme" name="titre_support" required="required" type="text" placeholder="donne un nom a votre theme "/>
                                </p>

                                <p> 
                                    <label for="nametheme" class="nametheme"  > Nom du support </label>
                                    <input id="nametheme" name="nom_support" required="required" type="text" placeholder="donne un nom a votre theme "/>
                                </p>


                                <p> 
                                    <label for="nametheme" class="nametheme"  > Image d'un theme </label>
                                    <input id="imageoftheme" name="image_support"  type="file" />
                                </p>
                               ...
                               <label for="namesupport" class="namesupport"  > Type du support </label> </br>
                                ...
                                <p> 
                                    ...
                                    <input id="imageoftheme" name="lien"  type="file" />
                                </p>
